...
Jutils (version 1.0) is a visualization toolkit for alternative splicing events. Jutils directly supports vizualizing results generated by the differential splicing (DS) detection tools MntJULiP, LeafCutter, MAJIQ and rMATS, and can be easily adapted to use with other DS software.
