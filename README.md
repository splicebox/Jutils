...
Described in:
   ...
   - Lui WW, Yang G, He Z and Florea L (2025). MntJULiP and Jutils: Differential splicing analysis of RNA-seq data with covariates. *NAR Genom Bioinform* [7{4):lqaf140](https://doi.org/10.1093/nargab/lqaf140) [[Suppl. data](http://ccb.jhu.edu/software/MntJULiP/), [Suppl. scripts](https://github.com/splicebox/MntJULiP/blob/master-covariate/MntJULiP_cov_scripts.tar.gz)]
...
```
Copyright (C) 2020-2025, and GNU GPL v3.0, by †Wui Wang Lui, †Guangyu Yang, Liliana Florea  († equal contributors)
```
...
Please submit a GitHub [Issue](https://github.com/splicebox/Jutils/issues). For demos on how to use the software, please see our Coursera [transcriptomics](https://www.coursera.org/learn/bioinformatics-methods-for-transcriptomics) course.
